...
class managementProduk extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->TOKEN= array(
        'token' =>  'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6bnVsbH0.QC0PJGvCERZyWRQWVY7kj1Vj6rAZZmC3UQcVKGI6SGA'
                        );
    ...
    public function index()
    {
     ...
     public function tambah()
     {
        ...
        // $data['kategori'] =json_decode($this->curl->simple_post($this->API.'/kategori/List_Kategori',$data2));
        // $data3['kategori'] = json_decode($this->curl->simple_post($this->API.'/barang/List_Barang',$this->TOKEN));
